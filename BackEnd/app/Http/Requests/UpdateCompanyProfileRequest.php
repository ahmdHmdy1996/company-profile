...
class UpdateCompanyProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // New page-based structure support
            'data.*' => 'sometimes|array', // Allow any page ID as key
            'data.*.data' => 'sometimes|array',
            'data.*.templateId' => 'sometimes|string|max:255',
            'data.*.content' => 'sometimes|array',
            'data.*.style' => 'sometimes|array',
        ];
    }
