...
const GeneralSettingsPage = ({ 
  ...
  const tabs = [
    ...
    { id: 'background', label: 'إعدادات الخلفية', icon: ImageIcon },
    { id: 'theme', label: 'إعدادات الثيم', icon: Palette }
  ];
  ...
  const themes = [
    ...
    },
    {
      id: 'professional',
      name: 'مهني',
      description: 'تصميم مهني وكلاسيكي',
      colors: {
        primary: '#1E40AF',
        secondary: '#374151',
        accent: '#059669',
    ...
    },
    {
      id: 'creative',
      name: 'إبداعي',
      description: 'تصميم إبداعي وملون',
      colors: {
        primary: '#7C3AED',
        secondary: '#EC4899',
        accent: '#F59E0B',
  ...
  const renderThemeSettings = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-800 mb-4">اختيار الثيم</h3>
      ...
      {localThemeSettings.selectedTheme && (
        <div>
          <h3 className="text-lg font-semibold text-gray-800 mb-4">تخصيص الألوان</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div key={key}>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {key === 'primary' ? 'اللون الأساسي' :
                   ...
                   key === 'background' ? 'لون الخلفية' : key}
                </label>
                <div className="flex items-center gap-3">
                  <input
                    type="color"
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gray-50">
      <PageHeader 
        ...
        subtitle="إدارة إعدادات الشركة والتصميم"
        showSaveButton={true}
        onSave={handleSave}
        isSaving={isSaving}
        ...
        <div className="mx-6 mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-medium text-yellow-800">تسجيل الدخول مطلوب</h3>
              <p className="text-sm text-yellow-700 mt-1">
                يجب تسجيل الدخول أولاً لحفظ الإعدادات في قاعدة البيانات
              </p>
            </div>
            <button
