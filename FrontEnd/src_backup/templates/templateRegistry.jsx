...
export const TEMPLATES = {
  ...
  About: {
    ...
    defaultData: {
      ...
      company: {
        title: "الشركة",
        content: "عملاؤنا هم شركاؤنا، وهذا هو السبب تحديداً في أننا ملتزمون تماماً بضمان رضا العملاء. بالإضافة إلى ذلك، نركز على تطوير الشراكات مع الشركات والأفراد الرائدين لنقدم لك قيمة مضافة.\n\nأعضاؤنا هم المحفز لازدهارنا وأعظم أصولنا. نحتفظ ونجند الأفضل، ونعزز العمل الجماعي الذي ينتج عنه أداء ممتاز. نوفر الدافع والفرص لمساعدة مواهبنا على اكتشاف قدراتهم الحقيقية.\n\nتفانينا في تقديم معايير عالية الجودة، والامتثال الكامل لمتطلبات المشروع، والتسليم في الوقت المحدد أمر ملموس. نحن مكرسون لتقديم خدمات TAB (الاختبار والموازنة) لضمان أن نظام HVAC (التدفئة والتهوية وتكييف الهواء) يوفر أقصى راحة للمقيم في المبنى باستخدام أقل تكلفة ممكنة للطاقة.\n\nلنصبح القائد في مجالنا، نحن مدفوعون لتحسين عملياتنا وتواصلنا وهيكلنا ونهجنا في تحديات البناء باستمرار. نحن نتبنى أحدث الاتجاهات والتقنيات بينما نبني على الطرق المثبتة.\n\nأعمالنا المتقدمة بسرعة تعتمد على الحفاظ على معايير الجودة والصحة/السلامة وتحقيقها والإجراءات. في شركة تيم أرابيا، نعتبر متطلبات الصحة والسلامة في بيئة العمل ذات أهمية قصوى. وهذا ينعكس من خلال عدم وجود أي حادث يمكن الإبلاغ عنه في جميع العمليات التي شاركنا فيها حتى الآن."
      },
      images: {
        topImage: null,
        middleImage: null,
    ...
    fields: [
      { key: "showHeader", label: "إظهار الهيدر", type: "checkbox", defaultValue: true },
      { key: "title", label: "العنوان الرئيسي", type: "textarea" },
      {
        key: "vision",
        label: "قسم الرؤية",
        type: "object",
        subFields: [
          { key: "title", label: "عنوان الرؤية", type: "text" },
          { key: "content", label: "محتوى الرؤية", type: "textarea" }
        ]
      },
      {
        key: "coreValues",
        ...
        type: "object",
        subFields: [
          { key: "title", label: "عنوان القيم", type: "text" },
          { key: "content", label: "وصف القيم", type: "textarea" },
          { key: "values", label: "قائمة القيم", type: "list" }
        ]
      },
      {
        key: "company",
        ...
        type: "object",
        subFields: [
          { key: "title", label: "عنوان الشركة", type: "text" },
          { key: "content", label: "وصف الشركة", type: "textarea" }
        ]
      },
      {
        key: "images",
        ...
        type: "object",
        subFields: [
          { key: "topImage", label: "صورة علوية", type: "image" },
          { key: "middleImage", label: "صورة وسطية", type: "image" },
          { key: "bottomImage", label: "صورة سفلية", type: "image" }
        ]
      }
    ],
  },
