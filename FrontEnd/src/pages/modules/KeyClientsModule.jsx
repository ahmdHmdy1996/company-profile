    ...
    <div className="max-w-7xl mx-auto">
      <div className="bg-white rounded-lg shadow-lg">
        <div className="border-b border-gray-200 px-6 py-4">
          <h1 className="text-2xl font-bold text-gray-800">مديول العملاء الرئيسيين</h1>
          <p className="text-gray-600 mt-1">إدارة صفحات ومحتوى قسم "العملاء الرئيسيين"</p>
        </div>
...
export default KeyClientsModule;